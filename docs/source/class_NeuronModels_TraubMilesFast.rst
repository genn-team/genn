...
.. _doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast:
...
Hodgkin-Huxley neurons with Traub & Miles algorithm: Original fast implementation, using 25 inner iterations. :ref:`More...<details-dc/d4c/classNeuronModels_1_1TraubMilesFast>`
...
.. ref-code-block:: cpp
	...
	class TraubMilesFast: public :ref:`NeuronModels::TraubMiles<doxid-d2/dc3/classNeuronModels_1_1TraubMiles>`
	{
	public:
		// typedefs
	
		typedef :ref:`Snippet::ValueBase<doxid-da/d76/classSnippet_1_1ValueBase>`<7> :target:`ParamValues<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1abed1cf119d8eff6694849c002bf81edf>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d6/d24/classModels_1_1VarInitContainerBase>`<4> :target:`VarValues<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1a02541b2343ee4007ece237fbe0d1b065>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d6/d24/classModels_1_1VarInitContainerBase>`<0> :target:`PreVarValues<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1a15dc3fa6a491ea4c1220bef255d01d4b>`;
		typedef :ref:`Models::VarInitContainerBase<doxid-d6/d24/classModels_1_1VarInitContainerBase>`<0> :target:`PostVarValues<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1a956f2e392e55f5d880e8dea744acf191>`;

		// methods
	
		static const NeuronModels::TraubMilesFast* :target:`getInstance<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1aed98055a1191523a1680f998f39460f5>`();
		virtual std::string :ref:`getSimCode<doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1a730858391f8529759644bb3c74950922>`() const;
	};
...
.. _details-dc/d4c/classNeuronModels_1_1TraubMilesFast:
...
.. _doxid-dc/d4c/classNeuronModels_1_1TraubMilesFast_1a730858391f8529759644bb3c74950922:
