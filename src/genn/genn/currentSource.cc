    ...
    m_ExtraGlobalParamLocation(defaultExtraGlobalParamLocation), m_TargetVar("Isyn")
{
    ...
    Models::resolveLocalReferences(neuronVarReferences,
    ...
    Models::resolveLocalReferences(neuronEGPReferences,
                                   m_NeuronEGPReferences, trgNeuronGroup,
    ...
    getModel()->validate(getParams(), getVarInitialisers(), getNeuronVarReferences(), getNeuronEGPReferences(),
    ...
    Models::checkLocalVarReferences(getNeuronVarReferences(), getModel()->getNeuronVarRefs(),
                                    getTrgNeuronGroup(), "Variable references in current source can only point to target neuron group.",
                                    &Models::VarReference::isTargetNeuronGroup);
    Models::checkLocalEGPReferences(getNeuronEGPReferences(), getTrgNeuronGroup(), 
                                    "EGP references in current source can only point to target neuron group.",
