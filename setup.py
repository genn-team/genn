...
ext_modules = [
    ...
    Pybind11Extension("init_sparse_connectivity_snippets",
                      [os.path.join(genn_wrapper_src, "initSparseConnectivitySnippets.cc")],
                      **genn_extension_kwargs),
    Pybind11Extension("init_toeplitz_connectivity_snippets",
                      [os.path.join(genn_wrapper_src, "initToeplitzConnectivitySnippets.cc")],
                      **genn_extension_kwargs),
    ...
    Pybind11Extension("current_source_models",
                      [os.path.join(genn_wrapper_src, "currentSourceModels.cc")],
                      **genn_extension_kwargs),
    Pybind11Extension("neuron_models",
                      [os.path.join(genn_wrapper_src, "neuronModels.cc")],
                      **genn_extension_kwargs),
    Pybind11Extension("postsynaptic_models",
                      [os.path.join(genn_wrapper_src, "postsynapticModels.cc")],
                      **genn_extension_kwargs),
    Pybind11Extension("weight_update_models",
                      [os.path.join(genn_wrapper_src, "weightUpdateModels.cc")],
                      **genn_extension_kwargs)]
