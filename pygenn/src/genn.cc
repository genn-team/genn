...
PYBIND11_MODULE(_genn, m) 
{
    ...
    pybind11::class_<SynapseGroup>(m, "SynapseGroup", pybind11::dynamic_attr())
        ...
        //WRAP_PROPERTY("delay_location",SynapseGroup, DelayLocation)
        .def_property("delay_location", &SynapseGroup::getDelayLocation, &SynapseGroup::setDelayLocation)
        ...
        //WRAP_PROPERTY("max_axonal_back_delay_timesteps", SynapseGroup, MaxAxonalBackDelayTimesteps)
        .def_property("max_axonal_back_delay_timesteps", &SynapseGroup::getMaxAxonalBackDelayTimesteps, &SynapseGroup::setMaxAxonalBackDelayTimesteps)
