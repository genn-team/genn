...
#define SET_NEEDS_ROW_SORT(ROW_SORT_REQUIRED) virtual bool isRowSortRequired() const{ return ROW_SORT_REQUIRED; }
...
public:
    ...
    //! After being generated by the row building code, should rows be sorted
     /*! **NOTE** sorting only occurs for data structures such as ragged matrices which aren't inherantly ordered */
    virtual bool isRowSortRequired() const{ return false; }
};
