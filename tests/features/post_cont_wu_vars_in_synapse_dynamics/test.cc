//--------------------------------------------------------------------------
/*! \file post_cont_wu_vars_in_synapse_dynamics/test.cc
...
#include "post_cont_wu_vars_in_synapse_dynamics_CODE/definitions.h"
...
TEST_F(SimTest, PostContWUVarsInSynapseDynamics)
{
  float err = Simulate(
