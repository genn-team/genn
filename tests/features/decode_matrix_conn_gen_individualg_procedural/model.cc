//--------------------------------------------------------------------------
/*! \file decode_matrix_conn_gen_individualg_procedural/model.cc
...
{
    model.setDT(0.1);
    model.setName("decode_matrix_conn_gen_individualg_procedural");
    ...
    model.addSynapsePopulation<WeightUpdateModels::StaticPulse, PostsynapticModels::DeltaCurr>(
        "Syn", SynapseMatrixType::PROCEDURAL_INDIVIDUALG, NO_DELAY, "Pre", "Post",
        {}, staticSynapseInit,
        {}, {},
