//--------------------------------------------------------------------------
/*! \file pre_output_decode_matrix_event_individualg_dense/test.cc
...
#include "pre_output_decode_matrix_event_individualg_dense_CODE/definitions.h"
...
TEST_F(SimTest, PreOutputDecodeMatrixEventIndividualgDense)
{
