//--------------------------------------------------------------------------
/*! \file decode_matrix_globalg_dense/model.cc
...
void modelDefinition(NNmodel &model)
{
    ...
    model.setDT(0.1);
    model.setName("decode_matrix_globalg_dense");
    ...
    model.addSynapsePopulation("Syn", NSYNAPSE, DENSE, GLOBALG, NO_DELAY, IZHIKEVICH_PS, "Pre", "Post",
                               synapses_ini, NULL,
                               NULL, NULL);
