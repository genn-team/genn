//--------------------------------------------------------------------------
/*! \file decode_matrix_globalg_bitmask_optimised/test.cc
...
#include "decode_matrix_globalg_bitmask_optimised_CODE/definitions.h"
...
TEST_F(SimTest, DecodeMatrixGlobalgBitmaskOptimised)
{
