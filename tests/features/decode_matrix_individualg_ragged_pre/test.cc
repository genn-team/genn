//--------------------------------------------------------------------------
/*! \file decode_matrix_individualg_ragged_pre/test.cc
...
#include "decode_matrix_individualg_ragged_pre_CODE/definitions.h"
...
TEST_F(SimTest, DecodeMatrixIndividualgRaggedPre)
{
