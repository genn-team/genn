//--------------------------------------------------------------------------
/*! \file pre_spike_event_time_in_post_learn/model.cc
...
public:
    ...
    SET_EVENT_THRESHOLD_CONDITION_CODE("$(t) >= (scalar)$(id) && fmodf($(t) - (scalar)$(id), 10.0f)< 1e-4");
    SET_LEARN_POST_CODE("$(w)= $(seT_pre);");
...
#endif
    model.setDT(1.0);
    model.setName("pre_spike_event_time_in_post_learn");
