...
#include "weight_update_support_code_scope_CODE/definitions.h"
...
typedef SimulationTestVars<SimulationNeuronPolicyPreVar, SimulationSynapsePolicyDense> SimulationTestSupportCodeScope;

TEST_P(SimulationTestSupportCodeScope, AcceptableError)
{
  float err = Simulate(
...
INSTANTIATE_TEST_CASE_P(WeightUpdateCode,
                        SimulationTestSupportCodeScope,
                        simulatorBackends);