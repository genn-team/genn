//--------------------------------------------------------------------------
/*! \file pre_output_decode_matrix_post_learn_individualg_dense/model.cc
...
public:
    ...
    SET_LEARN_POST_CODE("$(addToPre, $(g) * $(x_post));\n");
};
...
#endif
    model.setDT(0.1);
    model.setName("pre_output_decode_matrix_post_learn_individualg_dense");
