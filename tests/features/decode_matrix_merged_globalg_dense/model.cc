//--------------------------------------------------------------------------
/*! \file decode_matrix_merged_globalg_dense/model.cc
...
void modelDefinition(ModelSpec &model)
{
    ...
    model.setName("decode_matrix_merged_globalg_dense");
    ...
    model.addSynapsePopulation<WeightUpdateModels::StaticPulse, PostsynapticModels::DeltaCurr>(
        "Syn1", SynapseMatrixType::DENSE_GLOBALG, NO_DELAY, "Pre1", "Post",
        {}, staticSynapseInit,
        {}, {});
    model.addSynapsePopulation<WeightUpdateModels::StaticPulse, PostsynapticModels::DeltaCurr>(
        "Syn2", SynapseMatrixType::DENSE_GLOBALG, NO_DELAY, "Pre2", "Post",
        {}, staticSynapseInit,
        {}, {});
