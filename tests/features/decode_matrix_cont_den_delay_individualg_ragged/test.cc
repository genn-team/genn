//--------------------------------------------------------------------------
/*! \file decode_matrix_cont_den_delay_individualg_ragged/test.cc
...
#include "decode_matrix_cont_den_delay_individualg_ragged_CODE/definitions.h"
...
TEST_F(SimTest, DecodeMatrixContDenDelayIndividualgRagged)
{
