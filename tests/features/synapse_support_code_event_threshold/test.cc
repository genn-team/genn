...
typedef SimulationTestVars<SimulationNeuronPolicyPreVar, SimulationSynapsePolicyDense> SimulationTestSynapseSupportCode;

TEST_P(SimulationTestSynapseSupportCode, AcceptableError)
{
  float err = Simulate(
...
INSTANTIATE_TEST_CASE_P(EventThreshold,
                        SimulationTestSynapseSupportCode,
                        simulatorBackends);