//--------------------------------------------------------------------------
/*! \file decode_matrix_cont_den_delay_individualg_dense/test.cc
...
#include "decode_matrix_cont_den_delay_individualg_dense_CODE/definitions.h"
...
TEST_F(SimTest, DecodeMatrixContDenDelayIndividualgDense)
{
