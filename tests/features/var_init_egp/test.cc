...
protected:
    ...
    virtual void SetUp() override
    {
        ...
        valvconstantNeuronCustomUpdate = 7.0f;
        ...
        CONFIGURE_REPEAT_EGP(valuesvrepeatNeuronCustomUpdate);
...
TEST_F(SimTest, VarInitEGP)
{
    ...
    for(size_t i = 0; i < 100; i++) {
        ...
        EXPECT_EQ(vrepeatNeuronCustomUpdate[i], correctRepeatVal);
        ...
        EXPECT_EQ(vconstantNeuronCustomUpdate[i], 7.0f);
