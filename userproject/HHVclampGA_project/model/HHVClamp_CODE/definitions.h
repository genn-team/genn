...
\brief File generated from GeNN for the model HHVClamp containing useful Macros used for both GPU amd CPU versions.
*/
//-------------------------------------------------------------------------
...
extern unsigned int * glbSpkCntHH;
extern unsigned int * d_glbSpkCntHH;
extern unsigned int * glbSpkHH;
extern unsigned int * d_glbSpkHH;
extern scalar * VHH;
extern scalar * d_VHH;
extern scalar * mHH;
extern scalar * d_mHH;
...
extern scalar * d_nHH;
extern scalar * gNaHH;
extern scalar * d_gNaHH;
extern scalar * ENaHH;
extern scalar * d_ENaHH;
extern scalar * gKHH;
extern scalar * d_gKHH;
extern scalar * EKHH;
extern scalar * d_EKHH;
extern scalar * glHH;
extern scalar * d_glHH;
extern scalar * ElHH;
extern scalar * d_ElHH;
extern scalar * CHH;
extern scalar * d_CHH;
extern scalar * errHH;
extern scalar * d_errHH;
extern scalar stepVGHH;
extern scalar IsynGHH;

#define glbSpkShiftHH 0
#define spikeCount_HH glbSpkCntHH[0]
#define spike_HH glbSpkHH
...
void pushHHStateToDevice(bool hostInitialisedOnly = false);
void pushHHSpikesToDevice(bool hostInitialisedOnly = false);
void pushHHSpikeEventsToDevice(bool hostInitialisedOnly = false);
