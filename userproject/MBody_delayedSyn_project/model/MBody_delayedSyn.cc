...
void modelDefinition(NNmodel &model) 
{
    ...
    model.addSynapsePopulation<WeightUpdateModels::StaticGraded, PostsynapticModels::ExpCond>("LHIKC", SynapseMatrixType::DENSE_GLOBALG, NO_DELAY,
                                                                                              ...
                                                                                              postExpLHIKC, {});
    model.addSynapsePopulation<WeightUpdateModels::PiecewiseSTDP, PostsynapticModels::ExpCond>("KCDN", SynapseMatrixType::DENSE_INDIVIDUALG, 5,
                                                                                               "KC", "DN",
                                                                                               myKCDN_p, myKCDN_ini,
                                                                                               postExpKCDN, {});
    model.addSynapsePopulation<WeightUpdateModels::StaticGraded, PostsynapticModels::ExpCond>("DNDN", SynapseMatrixType::DENSE_GLOBALG, 3,
                                                                                              "DN", "DN",
                                                                                              myDNDN_p, myDNDN_ini,
                                                                                              postExpDNDN, {});
  #ifdef nGPU 
