...
class PresynapticUpdateGroupMergedBase;
class PresynapticSpikeUpdateGroupMerged;
class PresynapticSpikeEventUpdateGroupMerged;
...
public:
    ...
    void buildStandardEnvironment(EnvironmentGroupMergedField<PresynapticSpikeUpdateGroupMerged> &env, unsigned int batchSize) const;
    void buildStandardEnvironment(EnvironmentGroupMergedField<PresynapticSpikeEventUpdateGroupMerged>& env, unsigned int batchSize) const;
