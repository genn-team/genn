...
#define DECLARE_CUSTOM_UPDATE_MODEL(TYPE, NUM_PARAMS, NUM_VARS, NUM_VAR_REFS)                   \
    ...
    typedef Snippet::InitialiserContainerBase<WUVarReference, NUM_VAR_REFS> WUVarReferences;    \
    typedef Snippet::InitialiserContainerBase<VarReference, NUM_VAR_REFS> VarReferences;
