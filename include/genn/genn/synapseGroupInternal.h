...
public:
    ...
    using SynapseGroup::setFusedPostOutputSource;
    using SynapseGroup::setFusedPreOutputSource;
    using SynapseGroup::setFusedWUPreSource;
    using SynapseGroup::setFusedWUPostSource;
    ...
    using SynapseGroup::getFusedPostOutputSource;
    using SynapseGroup::getFusedPreOutputSource;
    using SynapseGroup::getFusedWUPreSource;
    using SynapseGroup::getFusedWUPostSource;
    ...
    using SynapseGroup::isPostOutputModelFused;
    using SynapseGroup::isPreOutputModelFused;
    using SynapseGroup::isWUPreModelFused;
    using SynapseGroup::isWUPostModelFused;
    using SynapseGroup::isPostOutputModelFuseSource;
    using SynapseGroup::isPreOutputModelFuseSource;
    using SynapseGroup::isWUPreModelFuseSource;
    using SynapseGroup::isWUPostModelFuseSource;
