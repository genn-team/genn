...
public:
    ...
    using SynapseGroup::canWUMPostUpdateBeMerged;
    ...
    using SynapseGroup::getPSMergeHashDigest;
    using SynapseGroup::getWUPreMergeHashDigest;
    using SynapseGroup::getWUPostMergeHashDigest;
