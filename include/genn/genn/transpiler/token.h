...
struct Token
{
    enum class Type
    {
        ...
        // Literals   
        IDENTIFIER, UINT32_NUMBER, INT32_NUMBER, FLOAT_NUMBER, DOUBLE_NUMBER, SCALAR_NUMBER, STRING,
        ...
        // Keywords
        DO, ELSE, FALSE, FOR, FOR_EACH_SYNAPSE, IF, TRUE, WHILE, SWITCH, CONTINUE, BREAK, CASE, DEFAULT,
