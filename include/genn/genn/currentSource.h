...
public:
    ...
    std::shared_ptr<const CurrentSourceModels::Base> getCurrentSourceModel() const{ return m_CurrentSourceModel; }
...
protected:
    CurrentSource(const std::string &name, std::shared_ptr<const CurrentSourceModels::Base> currentSourceModel,
...
private:
    ...
    std::shared_ptr<const CurrentSourceModels::Base> m_CurrentSourceModel;
