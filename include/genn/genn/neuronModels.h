...
//----------------------------------------------------------------------------
//! Rulkov Map neuron
/*! The RulkovMap type is a map based neuron model based on [Rulkov, 2002]_ but in
    the 1-dimensional map form used in [Nowotny et al., 2005]_:
    \f{eqnarray*}{
...
//----------------------------------------------------------------------------
//! Izhikevich neuron with fixed parameters [Izhikevich, 2003]_.
...
//----------------------------------------------------------------------------
//! Izhikevich neuron with variable parameters [Izhikevich, 2003]_.
...
/*! This conductance based model has been taken from [Traub and Miles, 1991]_ and can be described by the equations:
    \f{eqnarray*}{
