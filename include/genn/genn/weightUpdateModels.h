...
public:
    ...
    { 
        return getFilteredVars(true, true); 
    }
    ...
    {
        return getFilteredVars(true, false); 
    }
    ...
    { 
        return getFilteredVars(false, true); 
    }
...
private:
    ...
    // Private methods
    //------------------------------------------------------------------------
    std::vector<Base::SynapseVar> getFilteredVars(bool pre, bool post) const;
};
