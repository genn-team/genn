...
public:
    ...
    virtual void genAllocateMemPreamble(CodeStream &os, const ModelSpecMerged &modelMergedc) const override;
    ...
    void genGlobalDeviceRNG(CodeStream &definitions, CodeStream &definitionsInternal, CodeStream &runner, 
