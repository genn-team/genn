...
struct Preferences : public PreferencesBase
{
    ...
    WorkGroupSizeSelect blockSizeSelectMethod = WorkGroupSizeSelect::OCCUPANCY;
...
{
public:
    Backend(const KernelWorkGroupSize &kernelBlockSizes, const Preferences &preferences,
...
private:
    ...
    // Members
    //--------------------------------------------------------------------------
    const KernelWorkGroupSize m_KernelBlockSizes;
